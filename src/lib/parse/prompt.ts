...
// no markdown fences. For the core, condition.type is always "time".
...
Намір — це не «задача», а річ, що чекає на свою обставину (умову доречності). Для цього застосунку умова завжди часова.
...
- Якщо часу нема зовсім — постав розумний дефолт: kind "date" на сьогодні або daypart. НЕ вигадуй точну годину, якої користувач не називав.
